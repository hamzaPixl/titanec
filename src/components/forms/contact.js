...
export default function ContactForm({ formSuccess, handleSubmit, formError }) {
  ...
  return (
    <div className='text-light-900 gap-4 flex flex-col justify-between items-left text-base font-normal w-full'>
      {formSuccess && (
      ...
      )}
      {
        ...
        >
          ...
          <button
            type='submit'
            className='bg-light-900 text-white rounded-3xl flex flex-row gap-2 items-center px-4 py-2 hover:translate-x-1 transition-transform ease-in-out duration-300'
          >
